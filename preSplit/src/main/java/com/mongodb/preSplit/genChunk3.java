...
public class genChunk3 implements genChunk{
	...
	public genChunk3(String name, ObjectId epoch, MongoCollection<Document> destination, String firstKey, String secondKey, 
			String thirdKey) {
		ns = name;
		count = 0;
		myEpoch = epoch;
